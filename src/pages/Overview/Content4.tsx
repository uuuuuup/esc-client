...
export const Content4 = () => {
  return (
    <div className="w-full max-w-7xl m-auto mt-20 grid grid-cols-2 gap-10">
      ...
      <div>
        ...
        <div className="flex flex-row justify-center">
          <button className="my-10 text-2xl">1:1 멘토링 신청하기</button>
        </div>
        ...
        <div className="flex flex-row justify-center">
          <button className="my-10 text-2xl">멘토 신청하기</button>
        </div>
      </div>
    </div>
  );
