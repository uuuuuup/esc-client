  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl m-auto px-4">
        <div className="pt-10 mb-20 text-4xl md:text-5xl text-center">
          모두가 동등한 배움의 기회
        </div>
        <div className="mb-5 text-3xl md:text-4xl">단체 멘토링</div>
        <div className="mb-10 text-sm md:text-base">
          각 분야에서 매우 우수하고 탁월한 성과를 낸 학생들이 그들의 배움을
          나눔합니다. <br />
          그저 지식을 나눔하는 것이 아니라 배워가는 법을 나눕니다.
        </div>
        <div className="mb-5 text-xl md:text-2xl"> 대표 수업</div>
