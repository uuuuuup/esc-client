...
export function PrivatePolicy({ onClose }: PrivacyPolicyProps) {
  return (
    <div className="fixed top-0 z-40 w-full h-full">
      <div
        className="overflow-y-auto w-full h-full bg-transparent bg-black bg-opacity-50"
        onClick={onClose}
      >
        <div
          className="mt-20 mb-20 p-7 max-w-xl w-full mx-auto bg-white text-black"
          onClick={(ev) => {
            ev.stopPropagation();
          }}
        >
          ...
          <br />
          <div>
            회사명(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보
            ...
            브라우저에 보내는 소량의 정보이며 이용자들의 컴퓨터 내의
            하드디스크에 저장되기도 합니다.
            <br />
